...
describe("prototype pollution protection", () => {
  it("should throw when setting through __proto__", () => {
    ...
    expect(() => sp.set("__proto__.isAdmin" as never, true as never)).toThrow(
      TypeError
    );
  ...
  it("should throw when setting through constructor or prototype", () => {
    ...
    expect(() => sp.set("prototype.polluted" as never, true as never)).toThrow(
      TypeError
    );
    expect(({} as { isAdmin?: boolean }).isAdmin).toBeUndefined();
  });
  ...
  it("should throw when deleting through __proto__", () => {
    ...
    expect(() => sp.delete("__proto__.toString" as never)).toThrow(TypeError);
